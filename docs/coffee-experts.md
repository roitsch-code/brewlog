...
- **Asser Daily Pour-Over (Christensen)** — His "show-horse" daily V60: a 25/25/50 three-pour at 1:16 / 93 °C built around a STAGED-AGITATION contrast. Bloom 60 g (45 s), then a FORCEFUL second pour to 120 g (kettle raised, centre → out → centre) to guarantee even saturation, **drained fully**; then the final 50 % laid on ultra-gently at ~1–2 ml/s with the water column ≤1.5 cm — a slow, low-agitation percolation. Brewed on fast Cafec Abaca paper, so timings depend on the filter. Result: focused, clear flavours with bright, layered acidity. Tired-morning hack: pour the final 50 % through a dispersion/distribution screen ("big bloom, big pour, dispersion-screen percolation"). The inverse of the agitate-LATE recipes (e.g. Sweet & Balanced V60) — it agitates in the MIDDLE, then deliberately settles. (Owner-supplied transcript of Asser's own video; total time reconstructed from his stated cadence, Niche derived from his published Comandante 23–28 clicks.)
