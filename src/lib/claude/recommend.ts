 ...
 * observations from /api/insights ordered by relevance. Same import-
 * indirection rationale as RecommendLesson: this module stays free of
 * DB types. */
...
${roasterBlock}${historyBlock}${lessonsBlock}${insightsBlock}
Context:
- Occasion: ${context.occasion}
