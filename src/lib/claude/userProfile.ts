...
- No pour-control disc: the user does NOT use a Hario Drip Assist, Melodrip or any pour-control disc — not at home, not travelling. Never put one on a recipe or name one in a method string. Without a gooseneck he pours by hand (see "Kettle & pour control")
