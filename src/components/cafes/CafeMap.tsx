          ...
          <div className="bg-brew-surface/95 backdrop-blur-sm border border-brew-border rounded-2xl p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex flex-col items-end gap-2 shrink-0">
                ...
                <a
                  href={
                    placeSelected.lat != null && placeSelected.lng != null
                      ? `https://maps.google.com/maps?q=${placeSelected.lat},${placeSelected.lng}`
                      : `https://maps.google.com/maps?q=${encodeURIComponent(`${placeSelected.name} ${placeSelected.city}`)}`
                  }
                  target="_blank"
