...
const METHODS = [
  ...
  // No pour-control disc: the user does not brew with a Drip Assist, so it is not
  // offered here. (The disc machinery in the recipe layer stays dormant — nothing
  // sets preferredMethod to a disc method any more.)
];
